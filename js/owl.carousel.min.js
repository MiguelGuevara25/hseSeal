...
(function (e, t, n) {
  var r = {
    ...
    logIn: function () {
      ...
      e.orignalightms = e.options.items;
      e.checkBrowser();
      e.wrapperWidth = 0;
      e.checkVisible = null;
      e.setVars();
    ...
    setVars: function () {
      ...
      e.wrapItems();
      e.$owlightms = e.$elem.find(".owl-item");
    ...
    updateItems: function () {
      ...
      if (t.options.singleItem === true) {
        t.options.items = t.orignalightms = 1;
      ...
      if (n > (t.options.itemsDesktop[0] || t.orignalightms)) {
        t.options.items = t.orignalightms;
      }
    ...
    appendWrapperSizes: function () {
      var e = this,
        t = e.$owlightms.length * e.itemWidth;
    ...
    checkPagination: function () {
      ...
      t.paginationWrapper.find(".owl-page").each(function () {
        if (
          ...
          e(t.$owlightms[t.currentItem]).data("owl-roundPages")
        ) {
    ...
    autoHeight: function () {
      function s() {
        var r = e(n.$owlightms[n.currentItem]).height();
      ...
      var n = this,
        r = e(n.$owlightms[n.currentItem]).find("img"),
        i;
    ...
    onVisibleItems: function () {
      ...
      if (t.options.addClassActive === true) {
        t.$owlightms.removeClass("active");
      }
      t.visibleItems = [];
      for (n = t.currentItem; n < t.currentItem + t.options.items; n += 1) {
        t.visibleItems.push(n);
        if (t.options.addClassActive === true) {
          e(t.$owlightms[n]).addClass("active");
        }
      }
    ...
    singleItemTransition: function () {
      ...
      var e = this,
        t = e.outClass,
        n = e.inClass,
        r = e.$owlightms.eq(e.currentItem),
        i = e.$owlightms.eq(e.prevItem),
        s =
